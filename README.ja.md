...
Dockerインストールの場合は、パッケージをマウントするか、カスタムノードディレクトリに追加してください。

### n8n Cloud

**完全互換** - このパッケージはEventSub通知にNode.jsグローバルWebSocket（Node.js 21+）を使用しています。外部依存関係は不要です。
