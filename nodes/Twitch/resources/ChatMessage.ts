...
const sendMessageFields: INodeProperties[] = [
	...
	},
	{
		...
		description: 'Sender user ID or login name. This ID must match the user ID in the user access token. If a login name is provided, it will be automatically converted to user ID.',
	},
	{
		displayName: 'Message',
		name: 'message',
